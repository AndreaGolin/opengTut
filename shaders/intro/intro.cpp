...
/**
 * out vec4 vertexColor --> added output
 */
...
/**
 * vec4 vertexColot taken as input, and FragColor ser as vertexColor
 */
...
/**
 * This time we define FragColor as a Uniform
 * Uniforms are GLOBAL variables, unique per shader program
 * and accessible from all our shaders
 */
...
int main(int argc, char const *argv[])
{
    ...
    int fragmentShaderUniform = glCreateShader(GL_FRAGMENT_SHADER);
    ...
    if (!success)
    {
        ...
        std::cout << "ERROR::SHADER::PROGRAM_UNIFORM::LINKING_FAILED\n" << infoLog << std::endl;
    }
